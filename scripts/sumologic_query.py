...
@click.option('-e', '--endpoint', type=str, required=True, help='Sumologic endpoint', default='https://api.us2.sumologic.com/api')
@click.option('-ft', '--from-time', type=str, required=True, help='From time. Example: 2020-10-03T00:00:00 or 2020-10-03T21:00:00')
@click.option('-tt', '--to-time', type=str, required=True, help='From time. Example: 2020-10-03T00:00:00 or 2020-10-03T21:00:00')
@click.option('-tz', '--timezone', type=str, required=True, help='Timezone. Example: CET', default='CET')
@click.option('-rt', '--by-receipt-time', type=bool, required=True, help='ByReceiptTime', default=False)
@click.option('-v', '--verbose', is_flag=True, help='Verbose output. Disabled by default', default=False)
def sumo_query(**kwargs):
    ...
    for map in messages:
        ...
        try:
            ...
            map_dict = eval(map_string.replace('null', 'None').replace('true', 'True'))
